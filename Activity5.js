...
function displayResults(){
	...
	document.getElementById("results").innerHTML="<h2> Results </h2><br /> Average score = "+ average + "<br \> High score = "+ names[index]+ " with a score of " + highscore + "<br \> "
}
...
function addScore() {
    ...
    if (name == "" || isNaN(score) || score < 0 || score > 100) {
        alert("Please enter a name and a valid score");
    } else {
